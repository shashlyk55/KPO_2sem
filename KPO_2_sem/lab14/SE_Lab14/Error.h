...
#define ERROR_THROW_IN(id, l , c) Error::geterrorin(id, 1, c);		//	throw		ERROR_THROW(id, строка, колонка)
...
//	ERROR_ENTRY_NODEF10(ID) - 10 непоределенных элементов таблицы ошибок
